...
import { ContractCallEventObject } from '../../types/@axelar-network/axelar-cgp-solidity/contracts/AxelarGateway';
        ...
        for (const command of commands) {
            ...
            try {
                ...
                if (receipt) {
                    ...
                    let newGasWithTokenPaidEvent: GasReceipt<ContractCallWithTokenGasEvent>;
